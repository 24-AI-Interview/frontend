...
const BasicInfoPage = () => {
  ...
  const handleCheckNickname = () => {
    console.log(`Checking nickname: ${userInfo.nickname}`);
    alert('중복확인 로직을 여기에 구현하세요!');
  };
  const handleChangeEmail = () => {
    console.log(`Changing email to: ${userInfo.contactEmail}`);
    alert('이메일 변경 로직을 여기에 구현하세요!');
  };
  const handleVerifyPhone = () => {
    console.log(`Verifying phone number: ${userInfo.phoneNumber}`);
