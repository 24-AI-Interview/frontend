  ...
  return (
    <div className="category-select-page">
      ...
      <div className="category-select-container">
        <div className="category-select-bigbox">
            ...
            <div className="category-list">
              ...
              <ul>
                {Object.keys(jobCategories).map((major) => (
                  <li
                    key={major}
                    className={major === selectedMajor ? "active" : ""}
              ...
              {selectedMajor ? (
                <ul>
                  {jobCategories[selectedMajor].map((minor) => (
                    <li
                      key={minor}
                      className={minor === selectedMinor ? "active" : ""}
                ...
                <p className="placeholder">대분류를 먼저 선택하세요</p>
              )}
            </div>
          </div>
          ...
          <div className="category-preview">
            {selectedMajor && selectedMinor ? (
              <>
                ...
                <button className="btn-primary">선택완료</button>
              </>
            ) : (
